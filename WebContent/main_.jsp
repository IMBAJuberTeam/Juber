...
<!--           <img src="img/logo.png" alt="." class="hide"> -->
          <span class="hidden-folded m-l-xs">Louga欢迎您</span>
        </a>
        <!-- / brand -->
      </div>
      <!-- / navbar header -->
    ...
    <div class="bg-light lter b-b wrapper-md">
      <div class="row">
        <div class="col-sm-6 col-xs-12">
          <h1 class="m-n font-thin h3 text-black">报表统计</h1>
          <small class="text-muted">不知道该说什么好</small>
        </div>
      ...
      <div class="row">
        ...
        <div class="col-md-7">
          <div class="panel wrapper">
            ...
            <h4 class="font-thin m-t-none m-b text-muted">模拟支付宝的最近动态信息</h4>
