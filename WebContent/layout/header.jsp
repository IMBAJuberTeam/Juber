        ...
        <ul class="nav navbar-nav navbar-right">
          <li class="dropdown">
            <a href="#" data-toggle="dropdown" class="dropdown-toggle">
              ...
              <span class="visible-xs-inline">t</span>
            ...
            <div class="dropdown-menu w-xl animated fadeInUp">
              <div class="panel bg-white">
                <div class="panel-heading b-light bg-light">
                  <strong>你有 <span>2</span> 条未读通知信息</strong>
                </div>
                <div class="list-group">
                  <a href class="media list-group-item">
                    ...
                    <span class="media-body block m-b-none">
                      ...
                      <small class="text-muted">10 分钟之前</small>
                    </span>
                  </a>
                  <a href class="media list-group-item">
                    <span class="media-body block m-b-none">
                ...
                <div class="panel-footer text-sm">
                  ...
                  <a href="#notes" data-toggle="class:show animated fadeInRight">查看所有通知信息</a>
                </div>
              </div>
            </div>
            <!-- / dropdown -->
          ...
          <li class="dropdown">
            ...
            <ul class="dropdown-menu animated fadeInRight w">
              ...
              <li>
                <a ui-sref="app.page.profile">属性</a>
              </li>
              <li>
                <a ui-sref="app.docs">
